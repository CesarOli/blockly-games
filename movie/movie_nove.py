...
pencil_color('green')
draw_circle(50, range(1, 101) / 2, range(1, 101) / 2)
pencil_color('red')
if ((range(1, 101) > 50)):
    draw_circle(50, 80, 20)
else:
...
if ((range(1, 101) > 50)):
    draw_line(range(1, 101),0, 60, 20, 5)
    draw_line(100,(range(1, 101)), 0, 40, 20, 5)
else:
    draw_line(100 - range(1, 101), 0, 60, 20, 5)
    draw_line(range(1, 101), 0, 40, 20, 5)

draw_circle(20, 100 - range(1, 101), 5)
draw_circle(80, ((range(1, 101) - 50) / 5) ** 2, 60, 50, 5)
